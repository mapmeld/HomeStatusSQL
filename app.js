...
var urlReq = function(reqUrl, options, cb){
  ...
  app.get('/searchdb', function(req, res){
    ...
    var sendurl = 'http://nickd.iriscouch.com:5984/housing/_design/streetname/_view/streetname?startkey=' + encodeURIComponent( '"' + req.query["streetname"] + '"') + '&endkey=' + encodeURIComponent( '"' + req.query["streetname"] + '0"' );
