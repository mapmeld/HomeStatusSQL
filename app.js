...
var init = exports.init = function (config) {
  ...
  app.get('/osmgeo', function(req, res){
    ...
    var sendurl = 'http://nominatim.openstreetmap.org/search?format=json&q=' + encodeURIComponent(req.query["streetname"]) + "&maxlat=33.0363&maxlon=-83.2819&minlat=32.5745&minlon=-84.10583";
