...
var urlReq = function(reqUrl, options, cb){
  ...
  app.get('/searchdb', function(req, res){
    ...
    var streetname = req.query["streetname"].toLowerCase();

    var sendurl = 'http://nickd.iriscouch.com:5984/housing/_design/streetname/_view/streetname?startkey=' + encodeURIComponent( '"' + streetname + '"') + '&endkey=' + encodeURIComponent( '"' + streetname + '0"' );
