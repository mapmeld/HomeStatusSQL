...
var urlReq = function(reqUrl, options, cb){
  ...
  var street = req.query["streetname"].substring( req.query["streetname"].indexOf(" ") + 1, req.query["streetname"].indexOf(",") ).toLowerCase();
  if(street.indexOf("-") > -1){
    street = street.substring( street.indexOf("-") + 2 );
